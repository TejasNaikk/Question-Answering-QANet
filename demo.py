...
def answer():
    ...
    noun_words = [tag[0] for tag in pos_tags if tag[1]=="NN" or tag[1]=="NNP"]

    
    extra_info = "" 
    for nouns in noun_words:
 
	try:
    		curr_extra_info = wiki.summary(nouns,sentences=1)
	except:
		curr_extra_topics = wiki.search(nouns)
		choice = 1
		curr_extra_info = wiki.summary(curr_extra_topics[choice],sentences=1)
    ...
    print("I added this extra info:",extra_info)
